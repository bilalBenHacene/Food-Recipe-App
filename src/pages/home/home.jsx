    ...
    <div className="max-w-screen-xl mx-auto p-5 sm:p-10 md:p-16">
      ...
      >
        {recipes && recipes.length > 0 ? (
          ...
          <img
            src="https://cdni.iconscout.com/illustration/premium/thumb/fast-food-illustration-download-in-svg-png-gif-file-formats--fastfood-junk-burger-pizza-hot-dog-pack-drink-illustrations-3425151.png"
            alt=""
          />
        )}
      </div>
