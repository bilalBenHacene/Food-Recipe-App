  ...
  return (
    <div className="rounded overflow-hidden shadow-lg flex flex-col">
      ...
      <div className="px-6 py-3 flex flex-row items-center justify-between bg-gray-100">
        <span
          onClick={() => handleFavoriteList(item)}
          className="py-1 text-xs font-regular text-gray-900 mr-1 flex flex-row items-center cursor-pointer"
        >
          <AddFavorite
            fillColor={favorites?.indexOf(item) == -1 ? "#999999" : "#4f46e5"}
          />
        </span>

        <Link
          to={`/recipe/${item.id}`}
          className="py-1 text-xs font-regular text-gray-900 mr-1 flex flex-row items-center hover:text-blue-500 hover:scale-105"
        >
          <svg
            className="h-5"
            fill="none"
